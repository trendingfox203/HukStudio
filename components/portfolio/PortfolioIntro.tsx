  ...
  return (
    <div className="bg-black">
      ...
      <div className="flex flex-col gap-4 px-6 py-6 sm:flex-row sm:items-end sm:justify-between sm:px-10">
        <div>
          <p className="font-playfair text-sm font-medium tracking-[0.25em] text-white/90 uppercase">
            {hero.tagline}
          </p>
          <p className="mt-1 font-playfair text-lg text-white/60 italic">{hero.subtitle}</p>
        </div>
